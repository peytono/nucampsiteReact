...
import { Card, CardImg, CardText, CardBody, Breadcrumb, BreadcrumbItem, Button, Modal, ModalBody, ModalHeader, Col, Row, Label } from 'reactstrap';
        ...
        return(
            <div>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal} >
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={values => this.handleSubmit(values)} initialState={{ rating: "1" }}>
